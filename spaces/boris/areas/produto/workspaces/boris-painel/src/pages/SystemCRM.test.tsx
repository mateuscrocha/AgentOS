...
vi.mock("@/hooks/use-crm", () => ({
  ...
  CRM_STAGE_META: {
    ...
    qualification: { label: "Qualificação", shortLabel: "Qualificação", tone: "" },
    meeting: { label: "Reunião", shortLabel: "Reunião", tone: "" },
    proposal: { label: "Proposta", shortLabel: "Proposta", tone: "" },
    approval_pending: { label: "Aguardando aprovação", shortLabel: "Aprovação", tone: "" },
    customer: { label: "Cliente", shortLabel: "Cliente", tone: "" },
    lost: { label: "Perdido", shortLabel: "Perdido", tone: "" },
  },
  CRM_PIPELINE_STAGES: ["new_lead", "meeting", "proposal", "approval_pending", "customer", "lost"],
  ...
  CRM_DEAL_CONTACT_ROLE_META: {
    decision_maker: { label: "Decisor", tone: "" },
    operator: { label: "Operacional", tone: "" },
    champion: { label: "Sponsor", tone: "" },
    financial_buyer: { label: "Financeiro", tone: "" },
    influencer: { label: "Influenciador", tone: "" },
    unknown: { label: "Sem papel", tone: "" },
  },
  CRM_TASK_TYPE_META: {
  ...
  hasStripeBillingLink: () => false,
  isBillableRelationshipType: () => false,
  isNonPayingCustomerAccount: () => false,
  isNonPayingRelationshipType: () => false,
  isPayingCustomerAccount: () => false,
  useCRM: () => ({
    accounts: [],
    contacts: [],
    opportunities: [],
