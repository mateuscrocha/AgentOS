...
GRANT EXECUTE ON FUNCTION public.public_onboarding_provision_tx(uuid, text, text, text, text, text, text, text) TO anon, authenticated, service_role;
GRANT EXECUTE ON FUNCTION public.public_onboarding_provision_tx_v2(uuid, text, text, text, text, text, text, text, jsonb) TO anon, authenticated, service_role;
