-- Fix alert term matching for single-word terms.
-- Postgres regex word-boundary matching with \m...\M is failing in this environment,
-- causing valid word matches to be skipped. Since alert text/terms are normalized
-- (lowercase, unaccent, punctuation removed, collapsed spaces), a padded-space
-- containment check is reliable for "word" terms.
