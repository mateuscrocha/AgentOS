...
Este diretório concentra a biblioteca operacional do `boris` dentro do AgentOS.
...
O AgentOS passa a ser a casa principal do acervo do Boris.

Tudo que antes estava espalhado em pastas externas foi consolidado aqui, preservando referencias, producoes, assets, scripts e materiais de apoio.
