...
const Group = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1480px] animate-fade-in space-y-8 pb-8 sm:pb-10">
        <GroupPageTop
          breadcrumbItems={[
        ...
        {!welcomeDismissed && (
          <Card className="overflow-hidden rounded-[28px] border-amber-200/70 bg-white shadow-subtle">
            <CardContent className="p-6">
              <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-3">
                  <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-amber-700">
                  ...
                  <div className="grid gap-2 text-sm">
                    <div className="flex items-start gap-2 rounded-[var(--radius-md)] bg-amber-50 px-3 py-2 text-card-foreground">
